...
// Plug-in:
#define kWFPPluginName	"WFP"			// Name of this plug-in.
#define kWFPPrefixNumber	0xe9400 		// Unique prefix number for this plug-in(*Must* be obtained from Adobe Developer Support).
#define kWFPVersion		kSDKDefPluginVersionString						// Version of this plug-in (for the About Box).
#define kWFPAuthor		"Tim Vervelde"					// Author of this plug-in (for the About Box).
...
// ImplementationIDs:
DECLARE_PMID(kImplementationIDSpace, kWFPActionComponentImpl, kWFPPrefix + 0)
DECLARE_PMID(kImplementationIDSpace, kWFPDialogControllerImpl, kWFPPrefix + 1)
DECLARE_PMID(kImplementationIDSpace, kWFPDialogObserverImpl, kWFPPrefix + 2)
...
//DECLARE_PMID(kWidgetIDSpace, kWFPWidgetID, kWFPPrefix + 2)
//DECLARE_PMID(kWidgetIDSpace, kWFPWidgetID, kWFPPrefix + 3)
//DECLARE_PMID(kWidgetIDSpace, kWFPWidgetID, kWFPPrefix + 4)
...
#define kWFPFirstMajorFormatNumber  RezLong(1)
#define kWFPFirstMinorFormatNumber  RezLong(0)

// Data format version numbers for the PluginVersion resource 
#define kWFPCurrentMajorFormatNumber kWFPFirstMajorFormatNumber
#define kWFPCurrentMinorFormatNumber kWFPFirstMinorFormatNumber
